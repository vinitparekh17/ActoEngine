...
export function EntityListPanel({
    ...
    const filteredEntities = useMemo(() => {
        ...
        return filtered;
    }, [allEntities, searchQuery, sortBy, sortOrder, selectedProject?.databaseType, keepSelectedVisible, selectedEntityId, selectedEntityType]);
                                    ...
                                    {paginatedEntities.map((entity, index) => {
                                        ...
                                        return (
                                            <TableRow
                                                ...
                                                className={`cursor-pointer ${selected ? "bg-accent" : isFocused ? "bg-accent/50" : "hover:bg-accent"
                                                    }`}
                                            ...
                                            >
                                                ...
                                                <TableCell>
                                                    <InlineContextBadge
                                                        ...
                                                        variant="minimal"
                                                        preloadedContext={contextMap[`${entity.entityType}:${entity.entityId}`]}
                                                        disableFetch={true}
                            ...
                            {isLoadingTree ? (
                                ...
                                <TreeView
                                    ...
                                    onSelectNode={(node) => {
                                        ...
                                        if (type) {
                                            const entityId = parseInt(node.id.split("-").pop() || "0", 10);
                                            ...
                                            onSelectEntity(found || {
                                                ...
                                                schemaName: getDefaultSchema(selectedProject?.databaseType)
                                            });
                                        }
                                    }}
                                />
