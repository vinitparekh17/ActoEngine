    ...
    return (
        <div className="flex flex-col items-center justify-center h-full p-8 text-center">
            ...
            <p className="text-muted-foreground mb-8 max-w-sm">
                Select an entity from the left panel to view details, manage experts, and explore documentation.
            </p>
            ...
            <div className="grid grid-cols-1 gap-3 w-full max-w-xs">
                <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 text-left">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">Assign subject matter experts</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 text-left">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">Add business context and notes</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 text-left">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">Use Ctrl+K to search</p>
                    </div>
                </div>
            </div>
        </div>
