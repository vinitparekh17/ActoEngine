...
type DisplayMode = 'table' | 'input-table' | 'cards' | 'summary' | 'ignore';
...
interface PropMeta {
    id: string;      // Original XML tag name
    label: string;   // User-defined display name
    active: boolean; // Is included in output?
}
...
const buildPathGuard = (path: string): string => {
