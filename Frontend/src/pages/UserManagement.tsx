...
import type { UserDto, CreateUserRequest, UpdateUserRequest, Role } from '../types/user-management';
...
export default function UserManagementPage() {
    ...
    const { data: usersResponse, isLoading, error } = useApi<{ users: UserDto[], totalCount: number }>(
