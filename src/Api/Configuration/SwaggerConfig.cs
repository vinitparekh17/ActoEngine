    ...
    public static class SwaggerConfiguration
    {
        public static IServiceCollection AddCustomSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                { 
                    Title = "ActoX API", 
                    Version = "v1",
                    Description = "ActoX API with custom token-based authentication",
                    Contact = new OpenApiContact
                    {
                        Name = "ActoX Team",
                        Email = "contact@actox.com",
                        Url = new Uri("https://actox.com")
                    },
        ...
        public static IApplicationBuilder UseCustomSwagger(this IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment() || env.IsStaging())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ActoX API V1");
                    c.RoutePrefix = "swagger";
                    c.DocumentTitle = "ActoX API Documentation";
