...
public static class SecureConnectionBuilder
{
    ...
    /// If null, defaults to true in development and false otherwise.
    /// </param>
        ...
        IHostEnvironment? environment = null)
    {
        ...
        // Respect explicit caller values; only apply environment-based default when not provided.
        var effectiveTrustCert = trustServerCertificate
    ...
    /// Uses SqlCredential, which requires a SecureString password parameter.
    /// </summary>
    ...
    /// <remarks>
    /// The password arrives as a managed string, so converting it to SecureString does not
    /// provide meaningful additional protection for that original plaintext in memory.
    /// The conversion is performed to satisfy SqlCredential API requirements.
    /// </remarks>
    ...
    /// <summary>
    /// Creates a SecureString from a managed string.
    /// This does not retroactively protect the source plaintext string in memory.
    /// </summary>
