...
namespace ActoEngine.WebApi.Features.FormBuilder
{
    public class FormGenerationService(
        CodeTemplateRepository codeTemplateRepo,
        GenerationHistoryRepository generationHistoryRepo,
        TemplateRenderService templateService,
        ILogger<FormGenerationService> logger)
    {
        private readonly CodeTemplateRepository _codeTemplateRepo = codeTemplateRepo;
        private readonly GenerationHistoryRepository _generationHistoryRepo = generationHistoryRepo;
        private readonly TemplateRenderService _templateService = templateService;
        private readonly ILogger<FormGenerationService> _logger = logger;
