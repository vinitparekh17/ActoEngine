...
/// </summary>
internal sealed record EntityGroupSummary(
...
public sealed class ImpactVerdictBuilder
{
    ...
    private static List<VerdictReason> BuildReasons(ImpactResult analysis)
    {
        ...
        var rankedEntities = analysis.EntityImpacts
            ...
            .Select(g => new EntityGroupSummary(
                g.Key.EntityType,
    ...
    private static string BuildGroupedImplication(EntityGroupSummary group)
    {
    ...
    private static string BuildGroupedStatement(EntityGroupSummary group, string rootEntityNoun)
    {
